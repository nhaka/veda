...
class App {
    ...
    loadShaderOfEditor(editor, isSound) {
        ...
        return Promise.resolve()
            ...
            if (rc.glslify) {
                shader = (yield glslify_1.default(shader, path.dirname(filepath)))[0];
            }
        }))
            .then(() => {
            if (!isSound) {
    ...
    lint(editor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rc = this.config.createRc();
            if (rc.glslify) {
                const [newShader, offset] = yield glslify_1.default(shader, path.dirname(filepath));
                shader = newShader;
            ...
            const suffix = m[1];
            return validator_1.getGlslErrors(this.glslangValidatorPath, filepath, shader, suffix, glslifyOffset);
        });
    }
}
exports.default = App;
